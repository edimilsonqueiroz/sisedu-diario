            ...
            <div class="flex items-center justify-between flex-col h-full w-full">
                    ...
                    <div class="flex-1 w-full overflow-y-auto p-2">
                        @foreach($disciplines as $discipline)
                            <div wire:click="openEditDiscipline({{$discipline->id}})" key="{{$discipline->id}}" class="bg-slate-200 hover:bg-slate-400 cursor-pointer my-1 flex items-center justify-between rounded-md p-2">
