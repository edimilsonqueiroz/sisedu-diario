...
@include('components/header')
    <div class="p-2 w-full m-2 md:m-3">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div class="bg-slate-100 flex h-28 shadow-md rounded-md col-span-1">
                ...
                <div class="flex-1 p-2">
                    ...
                    <p class="font-semibold">Matrículas:</p>
                </div>
            </div>
            <div class="bg-slate-100 flex h-28 shadow-md rounded-md col-span-1">
                <div class="h-full rounded-l-md px-2 flex justify-center items-center bg-cyan-600">
                ...
                <div class="flex-1 p-2">
                    ...
                    <p class="font-semibold">Matriculas: </p>
                </div>
            </div>
        </div>
    </div>
